...
const UserForm: FC<UserFormProps> = ({ bikeRate }) => {
  ...
  const handleOnSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!prevBill) {
      ...
      const base = Number(date) < 15 ? PRICE_BASE_BEFORE : PRICE_BASE_AFTER;
  ...
  return (
    <div className="relative p-8 rounded-3xl overflow-hidden">
      {openModal && (
        <div className="bg-black/80 fixed inset-0 flex items-center justify-center flex-col">
            ...
            {!isBlocked ? (
              <>
                <div className="flex flex-col items-center justify-center space-y-1">
                  ...
                  <span className="font-semibold text-xl leading-6 text-black">
                    {totalPrice} USD
                  </span>
                </div>
              ...
              <>
                <div className="flex flex-col items-center justify-center space-y-1">
                  <p className="text-center text-sm text-black">
                    No puedes reservar porque ya alquilaste una anteriormente
                  </p>
                </div>
                <div className="flex space-x-6 px-6">
                  <button
